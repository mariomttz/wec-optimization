...
logging.basicConfig(
    ...
    handlers = [
        logging.FileHandler('sydney_49_nn_optimization.log'),
...
DATASET_FILE_NAME = 'sydney_49.csv'
RANDOM_SEED = 8
BATCH_SIZE = 1024
N_TRIALS = 1000
...
if __name__ == '__main__':
    try:
        ...
        results_path = 'sydney_49_nn_optuna_results.csv'
        ...
        model_path = 'sydney_49_nn_best_model'
